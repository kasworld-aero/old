$('document').ready(function() {
  $.getJSON("https://spreadsheets.google.com/feeds/list/1uT8y69qqzCxdHjh7_nR-41wwLAdnT2SUWYDJ8RyP6Hg/1/public/values?alt=json", function(data) {
    ...
    $('#kasads').html('<div class="bc-banner text-center"><a href="https://kasworld-aero.blogspot.com/p/advertise-with-us.html"><img src="https://s.clipartkey.com/mpngs/s/103-1030941_info-icon-blue-png-clipart-png-download-info.png" alt="Kasworld-Aero" style="height: 15px; width: 15px;cursor:pointer;position: absolute;color: white; top: 2px; right: 3px; z-index: 99999;"/> </a><a href="' + entry.gsx$url.$t +'"> <div class="bc-banner-body" style="background-image: url('+ entry.gsx$bgimg.$t +');"> <h2 style="color:'+ entry.gsx$txtcolor.$t +';">'+ entry.gsx$htxt.$t +'</h'+'2>  <p style="color:'+ entry.gsx$txtcolor.$t +';">'+ entry.gsx$ptxt.$t +'</p>  <center><span class="bc-btn" style="background: '+ entry.gsx$btnbgcolor.$t +';"><h3 style="color:'+ entry.gsx$btntxtcolor.$t +'">'+ entry.gsx$btntxt.$t +'</h3></span></cen'+'ter> </di'+'v> </d'+'iv></a>'); 
  });
});
